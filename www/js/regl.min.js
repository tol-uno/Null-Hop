// https://unpkg.com/regl@2.1.1/dist/regl.min.js
...
"]");return[e,f,w,a]});case "blend.equation":return b(function(a){if("string"===typeof a)return[ga[a],ga[a]];if("object"===typeof a)return[ga[a.rgb],ga[a.alpha]]},function(a,b,c){var d=a.constants.blendEquations,e=b.def(),f=b.def();a=a.cond("typeof ",c,'==="string"');a.then(e,"=",f,"=",d,"[",c,"];");a["else"](e,"=",d,"[",c,".rgb];",f,"=",d,"[",c,".alpha];");b(a);return[e,f]});case "blend.color":return b(function(a){return S(4,function(b){return+a[b]})},function(a,b,c){return S(4,function(a){return b.def("+",
...
b.def("!!",c,".invert");return[a,b]})}});return e}function U(a,b){var c=a["static"],d=a.dynamic,e={};Object.keys(c).forEach(function(a){var b=c[a],d;if("number"===typeof b||"boolean"===typeof b)d=x(function(){return b});else if("function"===typeof b){var f=b._reglType;if("texture2d"===f||"textureCube"===f)d=x(function(a){return a.link(b)});else if("framebuffer"===f||"framebufferCube"===f)d=x(function(a){return a.link(b.color[0])})}else pa(b)&&(d=x(function(a){return a.global.def("[",S(b.length,function(a){return b[a]}),
"]")}));d.value=b;e[a]=d});Object.keys(d).forEach(function(a){var b=d[a];e[a]=M(b,function(a,c){return a.invoke(c,b)})});return e}function ua(a,c){var d=a["static"],e=a.dynamic,g={};Object.keys(d).forEach(function(a){var c=d[a],e=b.id(a),w=new fa;if(Sa(c))w.state=1,w.buffer=f.getBuffer(f.create(c,34962,!1,!0)),w.type=0;else{var B=f.getBuffer(c);if(B)w.state=1,w.buffer=B,w.type=0;else if("constant"in c){var l=c.constant;w.buffer="null";w.state=2;"number"===typeof l?w.x=l:Ca.forEach(function(a,b){b<
l.length&&(w[a]=l[b])})}else{var B=Sa(c.buffer)?f.getBuffer(f.create(c.buffer,34962,!1,!0)):f.getBuffer(c.buffer),k=c.offset|0,h=c.stride|0,m=c.size|0,p=!!c.normalized,n=0;"type"in c&&(n=Ja[c.type]);c=c.divisor|0;w.buffer=B;w.state=1;w.size=m;w.normalized=p;w.type=n||B.dtype;w.offset=k;w.stride=h;w.divisor=c}}g[a]=x(function(a,b){var c=a.attribCache;if(e in c)return c[e];var d={isStream:!1};Object.keys(w).forEach(function(a){d[a]=w[a]});w.buffer&&(d.buffer=a.link(w.buffer),d.type=d.type||d.buffer+
".dtype");return c[e]=d})});Object.keys(e).forEach(function(a){var b=e[a];g[a]=M(b,function(a,c){function d(a){c(B[a],"=",e,".",a,"|0;")}var e=a.invoke(c,b),f=a.shared,w=a.constants,g=f.isBufferArgs,f=f.buffer,B={isStream:c.def(!1)},l=new fa;l.state=1;Object.keys(l).forEach(function(a){B[a]=c.def(""+l[a])});var k=B.buffer,h=B.type;c("if(",g,"(",e,")){",B.isStream,"=true;",k,"=",f,".createStream(",34962,",",e,");",h,"=",k,".dtype;","}else{",k,"=",f,".getBuffer(",e,");","if(",k,"){",h,"=",k,".dtype;",
'}else if("constant" in ',e,"){",B.state,"=",2,";","if(typeof "+e+'.constant === "number"){',B[Ca[0]],"=",e,".constant;",Ca.slice(1).map(function(a){return B[a]}).join("="),"=0;","}else{",Ca.map(function(a,b){return B[a]+"="+e+".constant.length>"+b+"?"+e+".constant["+b+"]:0;"}).join(""),"}}else{","if(",g,"(",e,".buffer)){",k,"=",f,".createStream(",34962,",",e,".buffer);","}else{",k,"=",f,".getBuffer(",e,".buffer);","}",h,'="type" in ',e,"?",w.glTypes,"[",e,".type]:",k,".dtype;",B.normalized,"=!!",
e,".normalized;");d("size");d("offset");d("stride");d("divisor");c("}}");c.exit("if(",B.isStream,"){",f,".destroyStream(",k,");","}");return B})});return g}function H(a){var b=a["static"],c=a.dynamic,d={};Object.keys(b).forEach(function(a){var c=b[a];d[a]=x(function(a,b){return"number"===typeof c||"boolean"===typeof c?""+c:a.link(c)})});Object.keys(c).forEach(function(a){var b=c[a];d[a]=M(b,function(a,c){return a.invoke(c,b)})});return d}function z(a,b,d,e,f){function l(a){var b=p[a];b&&(ba[a]=b)}
var k=Q(a,b),m=I(a,f),p=E(a,m,f),n=O(a,f),ba=y(a,f),q=J(a,f,k);l("viewport");l(g("scissor.box"));var Xb=0<Object.keys(ba).length,m={framebuffer:m,draw:n,shader:q,state:ba,dirty:Xb,scopeVAO:null,drawVAO:null,useVAO:!1,attributes:{}};m.profile=t(a,f);m.uniforms=U(d,f);m.drawVAO=m.scopeVAO=n.vao;if(!m.drawVAO&&q.program&&!k&&c.angle_instanced_arrays&&n["static"].elements){var r=!0;a=q.program.attributes.map(function(a){a=b["static"][a];r=r&&!!a;return a});if(r&&0<a.length){var v=h.getVAO(h.createVAO({attributes:a,
elements:n["static"].elements}));m.drawVAO=new L(null,null,null,function(a,b){return a.link(v)});m.useVAO=!0}}k?m.useVAO=!0:m.attributes=ua(b,f);m.context=H(e,f);return m}function ia(a,b,c){var d=a.shared.context,e=a.scope();Object.keys(c).forEach(function(f){b.save(d,"."+f);var g=c[f].append(a,b);Array.isArray(g)?e(d,".",f,"=[",g.join(),"];"):e(d,".",f,"=",g,";")});b(e)}function T(a,b,c,d){var e=a.shared,f=e.gl,g=e.framebuffer,l;Ma&&(l=b.def(e.extensions,".webgl_draw_buffers"));var k=a.constants,
e=k.drawBuffer,k=k.backBuffer;a=c?c.append(a,b):b.def(g,".next");d||b("if(",a,"!==",g,".cur){");b("if(",a,"){",f,".bindFramebuffer(",36160,",",a,".framebuffer);");Ma&&b(l,".drawBuffersWEBGL(",e,"[",a,".colorAttachments.length]);");b("}else{",f,".bindFramebuffer(",36160,",null);");Ma&&b(l,".drawBuffersWEBGL(",k,");");b("}",g,".cur=",a,";");d||b("}")}function za(a,b,c){var d=a.shared,e=d.gl,f=a.current,k=a.next,l=d.current,m=d.next,h=a.cond(l,".dirty");Na.forEach(function(b){b=g(b);if(!(b in c.state)){var d,
B;if(b in k){d=k[b];B=f[b];var n=S(ra[b].length,function(a){return h.def(d,"[",a,"]")});h(a.cond(n.map(function(a,b){return a+"!=="+B+"["+b+"]"}).join("||")).then(e,".",ta[b],"(",n,");",n.map(function(a,b){return B+"["+b+"]="+a}).join(";"),";"))}else d=h.def(m,".",b),n=a.cond(d,"!==",l,".",b),h(n),b in sa?n(a.cond(d).then(e,".enable(",sa[b],");")["else"](e,".disable(",sa[b],");"),l,".",b,"=",d,";"):n(e,".",ta[b],"(",d,");",l,".",b,"=",d,";")}});0===Object.keys(c.state).length&&h(l,".dirty=false;");
b(h)}function K(a,b,c,d){var e=a.shared,f=a.current,g=e.current,l=e.gl;yb(Object.keys(c)).forEach(function(e){var k=c[e];if(!d||d(k)){var h=k.append(a,b);if(sa[e]){var m=sa[e];va(k)?h?b(l,".enable(",m,");"):b(l,".disable(",m,");"):b(a.cond(h).then(l,".enable(",m,");")["else"](l,".disable(",m,");"));b(g,".",e,"=",h,";")}else if(pa(h)){var n=f[e];b(l,".",ta[e],"(",h,");",h.map(function(a,b){return n+"["+b+"]="+a}).join(";"),";")}else b(l,".",ta[e],"(",h,");",g,".",e,"=",h,";")}})}function P(a,b){X&&
(a.instancing=b.def(a.shared.extensions,".angle_instanced_arrays"))}function G(a,b,c,d,e){function f(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function g(a){t=b.def();a(t,"=",f(),";");"string"===typeof e?a(m,".count+=",e,";"):a(m,".count++;");p&&(d?(r=b.def(),a(r,"=",q,".getNumPendingQueries();")):a(q,".beginQuery(",m,");"))}function l(a){a(m,".cpuTime+=",f(),"-",t,";");p&&(d?a(q,".pushScopeStats(",r,",",q,".getNumPendingQueries(),",m,");"):a(q,".endQuery();"))}function k(a){var c=
b.def(n,".profile");b(n,".profile=",a,";");b.exit(n,".profile=",c,";")}var h=a.shared,m=a.stats,n=h.current,q=h.timer;c=c.profile;var t,r;if(c){if(va(c)){c.enable?(g(b),l(b.exit),k("true")):k("false");return}c=c.append(a,b);k(c)}else c=b.def(n,".profile");h=a.block();g(h);b("if(",c,"){",h,"}");a=a.block();l(a);b.exit("if(",c,"){",a,"}")}function ha(a,b,c,d,e){function f(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;
default:return 1}}function g(c,d,e){function f(){b("if(!",n,".buffer){",h,".enableVertexAttribArray(",m,");}");var c=e.type,g;g=e.size?b.def(e.size,"||",d):d;b("if(",n,".type!==",c,"||",n,".size!==",g,"||",q.map(function(a){return n+"."+a+"!=="+e[a]}).join("||"),"){",h,".bindBuffer(",34962,",",p,".buffer);",h,".vertexAttribPointer(",[m,g,c,e.normalized,e.stride,e.offset],");",n,".type=",c,";",n,".size=",g,";",q.map(function(a){return n+"."+a+"="+e[a]+";"}).join(""),"}");X&&(c=e.divisor,b("if(",n,
".divisor!==",c,"){",a.instancing,".vertexAttribDivisorANGLE(",[m,c],");",n,".divisor=",c,";}"))}function k(){b("if(",n,".buffer){",h,".disableVertexAttribArray(",m,");",n,".buffer=null;","}if(",Ca.map(function(a,b){return n+"."+a+"!=="+da[b]}).join("||"),"){",h,".vertexAttrib4f(",m,",",da,");",Ca.map(function(a,b){return n+"."+a+"="+da[b]+";"}).join(""),"}")}var h=l.gl,m=b.def(c,".location"),n=b.def(l.attributes,"[",m,"]");c=e.state;var p=e.buffer,da=[e.x,e.y,e.z,e.w],q=["buffer","normalized","offset",
"stride"];1===c?f():2===c?k():(b("if(",c,"===",1,"){"),f(),b("}else{"),k(),b("}"))}var l=a.shared;d.forEach(function(d){var l=d.name,k=c.attributes[l],h;if(k){if(!e(k))return;h=k.append(a,b)}else{if(!e(Ab))return;var m=a.scopeAttrib(l);h={};Object.keys(new fa).forEach(function(a){h[a]=b.def(m,".",a)})}g(a.link(d),f(d.info.type),h)})}function R(a,c,d,e,f,g){for(var l=a.shared,k=l.gl,h,m=0;m<e.length;++m){var n=e[m],p=n.name,q=n.info.type,t=d.uniforms[p],n=a.link(n)+".location",r;if(t){if(!f(t))continue;
if(va(t)){p=t.value;if(35678===q||35680===q)q=a.link(p._texture||p.color[0]._texture),c(k,".uniform1i(",n,",",q+".bind());"),c.exit(q,".unbind();");else if(35674===q||35675===q||35676===q)p=a.global.def("new Float32Array(["+Array.prototype.slice.call(p)+"])"),t=2,35675===q?t=3:35676===q&&(t=4),c(k,".uniformMatrix",t,"fv(",n,",false,",p,");");else{switch(q){case 5126:h="1f";break;case 35664:h="2f";break;case 35665:h="3f";break;case 35666:h="4f";break;case 35670:h="1i";break;case 5124:h="1i";break;
case 35671:h="2i";break;case 35667:h="2i";break;case 35672:h="3i";break;case 35668:h="3i";break;case 35673:h="4i";break;case 35669:h="4i"}c(k,".uniform",h,"(",n,",",pa(p)?Array.prototype.slice.call(p):p,");")}continue}else r=t.append(a,c)}else{if(!f(Ab))continue;r=c.def(l.uniforms,"[",b.id(p),"]")}35678===q?c("if(",r,"&&",r,'._reglType==="framebuffer"){',r,"=",r,".color[0];","}"):35680===q&&c("if(",r,"&&",r,'._reglType==="framebufferCube"){',r,"=",r,".color[0];","}");p=1;switch(q){case 35678:case 35680:q=
c.def(r,"._texture");c(k,".uniform1i(",n,",",q,".bind());");c.exit(q,".unbind();");continue;case 5124:case 35670:h="1i";break;case 35667:case 35671:h="2i";p=2;break;case 35668:case 35672:h="3i";p=3;break;case 35669:case 35673:h="4i";p=4;break;case 5126:h="1f";break;case 35664:h="2f";p=2;break;case 35665:h="3f";p=3;break;case 35666:h="4f";p=4;break;case 35674:h="Matrix2fv";break;case 35675:h="Matrix3fv";break;case 35676:h="Matrix4fv"}if("M"===h.charAt(0)){c(k,".uniform",h,"(",n,",");var n=Math.pow(q-
35674+2,2),v=a.global.def("new Float32Array(",n,")");Array.isArray(r)?c("false,(",S(n,function(a){return v+"["+a+"]="+r[a]}),",",v,")"):c("false,(Array.isArray(",r,")||",r," instanceof Float32Array)?",r,":(",S(n,function(a){return v+"["+a+"]="+r+"["+a+"]"}),",",v,")");c(");")}else{if(1<p){for(var q=[],u=[],t=0;t<p;++t)Array.isArray(r)?u.push(r[t]):u.push(c.def(r+"["+t+"]")),g&&q.push(c.def());g&&c("if(!",a.batchId,"||",q.map(function(a,b){return a+"!=="+u[b]}).join("||"),"){",q.map(function(a,b){return a+
"="+u[b]+";"}).join(""));c(k,".uniform",h,"(",n,",",u.join(","),");")}else g&&(q=c.def(),c("if(!",a.batchId,"||",q,"!==",r,"){",q,"=",r,";")),c(k,".uniform",h,"(",n,",",r,");");g&&c("}")}}}function V(a,b,c,d){function e(f){var g=m[f];return g?g.contextDep&&d.contextDynamic||g.propDep?g.append(a,c):g.append(a,b):b.def(l,".",f)}function f(){function a(){c(v,".drawElementsInstancedANGLE(",[p,r,u,q+"<<(("+u+"-5121)>>1)",t],");")}function b(){c(v,".drawArraysInstancedANGLE(",[p,q,r,t],");")}n&&"null"!==
n?C?a():(c("if(",n,"){"),a(),c("}else{"),b(),c("}")):b()}function g(){function a(){c(k+".drawElements("+[p,r,u,q+"<<(("+u+"-5121)>>1)"]+");")}function b(){c(k+".drawArrays("+[p,q,r]+");")}n&&"null"!==n?C?a():(c("if(",n,"){"),a(),c("}else{"),b(),c("}")):b()}var h=a.shared,k=h.gl,l=h.draw,m=d.draw,n=function(){var e=m.elements,f=b;if(e){if(e.contextDep&&d.contextDynamic||e.propDep)f=c;e=e.append(a,f);m.elementsActive&&f("if("+e+")"+k+".bindBuffer(34963,"+e+".buffer.buffer);")}else e=f.def(),f(e,"=",
l,".","elements",";","if(",e,"){",k,".bindBuffer(",34963,",",e,".buffer.buffer);}","else if(",h.vao,".currentVAO){",e,"=",a.shared.elements+".getElements("+h.vao,".currentVAO.elements);",ma?"":"if("+e+")"+k+".bindBuffer(34963,"+e+".buffer.buffer);","}");return e}(),p=e("primitive"),q=e("offset"),r=function(){var e=m.count,f=b;if(e){if(e.contextDep&&d.contextDynamic||e.propDep)f=c;e=e.append(a,f)}else e=f.def(l,".","count");return e}();if("number"===typeof r){if(0===r)return}else c("if(",r,"){"),c.exit("}");
var t,v;X&&(t=e("instances"),v=a.instancing);var u=n+".type",C=m.elements&&va(m.elements)&&!m.vaoActive;X&&("number"!==typeof t||0<=t)?"string"===typeof t?(c("if(",t,">0){"),f(),c("}else if(",t,"<0){"),g(),c("}")):f():g()}function ea(a,b,c,d,e){b=D();e=b.proc("body",e);X&&(b.instancing=e.def(b.shared.extensions,".angle_instanced_arrays"));a(b,e,c,d);return b.compile().body}function Z(a,b,c,d){P(a,b);c.useVAO?c.drawVAO?b(a.shared.vao,".setVAO(",c.drawVAO.append(a,b),");"):b(a.shared.vao,".setVAO(",
a.shared.vao,".targetVAO);"):(b(a.shared.vao,".setVAO(null);"),ha(a,b,c,d.attributes,function(){return!0}));R(a,b,c,d.uniforms,function(){return!0},!1);V(a,b,b,c)}function Ea(a,b){var c=a.proc("draw",1);P(a,c);ia(a,c,b.context);T(a,c,b.framebuffer);za(a,c,b);K(a,c,b.state);G(a,c,b,!1,!0);var d=b.shader.progVar.append(a,c);c(a.shared.gl,".useProgram(",d,".program);");if(b.shader.program)Z(a,c,b,b.shader.program);else{c(a.shared.vao,".setVAO(null);");var e=a.global.def("{}"),f=c.def(d,".id"),g=c.def(e,
"[",f,"]");c(a.cond(g).then(g,".call(this,a0);")["else"](g,"=",e,"[",f,"]=",a.link(function(c){return ea(Z,a,b,c,1)}),"(",d,");",g,".call(this,a0);"))}0<Object.keys(b.state).length&&c(a.shared.current,".dirty=true;");a.shared.vao&&c(a.shared.vao,".setVAO(null);")}function na(a,b,c,d){function e(){return!0}a.batchId="a1";P(a,b);ha(a,b,c,d.attributes,e);R(a,b,c,d.uniforms,e,!1);V(a,b,b,c)}function oa(a,b,c,d){function e(a){return a.contextDep&&g||a.propDep}function f(a){return!e(a)}P(a,b);var g=c.contextDep,
h=b.def(),k=b.def();a.shared.props=k;a.batchId=h;var l=a.scope(),m=a.scope();b(l.entry,"for(",h,"=0;",h,"<","a1",";++",h,"){",k,"=","a0","[",h,"];",m,"}",l.exit);c.needsContext&&ia(a,m,c.context);c.needsFramebuffer&&T(a,m,c.framebuffer);K(a,m,c.state,e);c.profile&&e(c.profile)&&G(a,m,c,!1,!0);d?(c.useVAO?c.drawVAO?e(c.drawVAO)?m(a.shared.vao,".setVAO(",c.drawVAO.append(a,m),");"):l(a.shared.vao,".setVAO(",c.drawVAO.append(a,l),");"):l(a.shared.vao,".setVAO(",a.shared.vao,".targetVAO);"):(l(a.shared.vao,
".setVAO(null);"),ha(a,l,c,d.attributes,f),ha(a,m,c,d.attributes,e)),R(a,l,c,d.uniforms,f,!1),R(a,m,c,d.uniforms,e,!0),V(a,l,m,c)):(b=a.global.def("{}"),d=c.shader.progVar.append(a,m),k=m.def(d,".id"),l=m.def(b,"[",k,"]"),m(a.shared.gl,".useProgram(",d,".program);","if(!",l,"){",l,"=",b,"[",k,"]=",a.link(function(b){return ea(na,a,c,b,2)}),"(",d,");}",l,".call(this,a0[",h,"],",h,");"))}function W(a,b){function c(a){return a.contextDep&&e||a.propDep}var d=a.proc("batch",2);a.batchId="0";P(a,d);var e=
!1,f=!0;Object.keys(b.context).forEach(function(a){e=e||b.context[a].propDep});e||(ia(a,d,b.context),f=!1);var g=b.framebuffer,h=!1;g?(g.propDep?e=h=!0:g.contextDep&&e&&(h=!0),h||T(a,d,g)):T(a,d,null);b.state.viewport&&b.state.viewport.propDep&&(e=!0);za(a,d,b);K(a,d,b.state,function(a){return!c(a)});b.profile&&c(b.profile)||G(a,d,b,!1,"a1");b.contextDep=e;b.needsContext=f;b.needsFramebuffer=h;f=b.shader.progVar;if(f.contextDep&&e||f.propDep)oa(a,d,b,null);else if(f=f.append(a,d),d(a.shared.gl,".useProgram(",
f,".program);"),b.shader.program)oa(a,d,b,b.shader.program);else{d(a.shared.vao,".setVAO(null);");var g=a.global.def("{}"),h=d.def(f,".id"),l=d.def(g,"[",h,"]");d(a.cond(l).then(l,".call(this,a0,a1);")["else"](l,"=",g,"[",h,"]=",a.link(function(c){return ea(oa,a,b,c,2)}),"(",f,");",l,".call(this,a0,a1);"))}0<Object.keys(b.state).length&&d(a.shared.current,".dirty=true;");a.shared.vao&&d(a.shared.vao,".setVAO(null);")}function ja(a,c){function d(b){var g=c.shader[b];g&&e.set(f.shader,"."+b,g.append(a,
e))}var e=a.proc("scope",3);a.batchId="a2";var f=a.shared,g=f.current;ia(a,e,c.context);c.framebuffer&&c.framebuffer.append(a,e);yb(Object.keys(c.state)).forEach(function(b){var d=c.state[b].append(a,e);pa(d)?d.forEach(function(c,d){e.set(a.next[b],"["+d+"]",c)}):e.set(f.next,"."+b,d)});G(a,e,c,!0,!0);["elements","offset","count","instances","primitive"].forEach(function(b){var d=c.draw[b];d&&e.set(f.draw,"."+b,""+d.append(a,e))});Object.keys(c.uniforms).forEach(function(d){var g=c.uniforms[d].append(a,
e);Array.isArray(g)&&(g="["+g.join()+"]");e.set(f.uniforms,"["+b.id(d)+"]",g)});Object.keys(c.attributes).forEach(function(b){var d=c.attributes[b].append(a,e),f=a.scopeAttrib(b);Object.keys(new fa).forEach(function(a){e.set(f,"."+a,d[a])})});c.scopeVAO&&e.set(f.vao,".targetVAO",c.scopeVAO.append(a,e));d("vert");d("frag");0<Object.keys(c.state).length&&(e(g,".dirty=true;"),e.exit(g,".dirty=true;"));e("a1(",a.shared.context,",a0,",a.batchId,");")}function ka(a){if("object"===typeof a&&!pa(a)){for(var b=
Object.keys(a),c=0;c<b.length;++c)if(Y.isDynamic(a[b[c]]))return!0;return!1}}function aa(a,b,c){function d(a,b){g.forEach(function(c){var d=e[c];Y.isDynamic(d)&&(d=a.invoke(b,d),b(m,".",c,"=",d,";"))})}var e=b["static"][c];if(e&&ka(e)){var f=a.global,g=Object.keys(e),h=!1,l=!1,k=!1,m=a.global.def("{}");g.forEach(function(b){var c=e[b];if(Y.isDynamic(c))"function"===typeof c&&(c=e[b]=Y.unbox(c)),b=M(c,null),h=h||b.thisDep,k=k||b.propDep,l=l||b.contextDep;else{f(m,".",b,"=");switch(typeof c){case "number":f(c);
break;case "string":f('"',c,'"');break;case "object":Array.isArray(c)&&f("[",c.join(),"]");break;default:f(a.link(c))}f(";")}});b.dynamic[c]=new Y.DynamicVariable(4,{thisDep:h,contextDep:l,propDep:k,ref:m,append:d});delete b["static"][c]}}var fa=h.Record,ga={add:32774,subtract:32778,"reverse subtract":32779};c.ext_blend_minmax&&(ga.min=32775,ga.max=32776);var X=c.angle_instanced_arrays,Ma=c.webgl_draw_buffers,ma=c.oes_vertex_array_object,ra={dirty:!0,profile:k.profile},Da={},Na=[],sa={},ta={};r("dither",
3024);r("blend.enable",3042);l("blend.color","blendColor",[0,0,0,0]);l("blend.equation","blendEquationSeparate",[32774,32774]);l("blend.func","blendFuncSeparate",[1,0,1,0]);r("depth.enable",2929,!0);l("depth.func","depthFunc",513);l("depth.range","depthRange",[0,1]);l("depth.mask","depthMask",!0);l("colorMask","colorMask",[!0,!0,!0,!0]);r("cull.enable",2884);l("cull.face","cullFace",1029);l("frontFace","frontFace",2305);l("lineWidth","lineWidth",1);r("polygonOffset.enable",32823);l("polygonOffset.offset",
"polygonOffset",[0,0]);r("sample.alpha",32926);r("sample.enable",32928);l("sample.coverage","sampleCoverage",[1,!1]);r("stencil.enable",2960);l("stencil.mask","stencilMask",-1);l("stencil.func","stencilFunc",[519,0,-1]);l("stencil.opFront","stencilOpSeparate",[1028,7680,7680,7680]);l("stencil.opBack","stencilOpSeparate",[1029,7680,7680,7680]);r("scissor.enable",3089);l("scissor.box","scissor",[0,0,a.drawingBufferWidth,a.drawingBufferHeight]);l("viewport","viewport",[0,0,a.drawingBufferWidth,a.drawingBufferHeight]);
var tb={gl:a,context:C,strings:b,next:Da,current:ra,draw:m,elements:d,buffer:f,shader:v,attributes:h.state,vao:h,uniforms:u,framebuffer:n,extensions:c,timer:p,isBufferArgs:Sa},Pa={primTypes:Ka,compareFuncs:ab,blendFuncs:Fa,blendEquations:ga,stencilOps:Ta,glTypes:Ja,orientationType:zb};Ma&&(Pa.backBuffer=[1029],Pa.drawBuffer=S(e.maxDrawbuffers,function(a){return 0===a?[0]:S(a,function(a){return 36064+a})}));var qa=0;return{next:Da,current:ra,procs:function(){var a=D(),b=a.proc("poll"),d=a.proc("refresh"),
f=a.block();b(f);d(f);var g=a.shared,h=g.gl,l=g.next,k=g.current;f(k,".dirty=false;");T(a,b);T(a,d,null,!0);var m;X&&(m=a.link(X));c.oes_vertex_array_object&&d(a.link(c.oes_vertex_array_object),".bindVertexArrayOES(null);");for(var n=0;n<e.maxAttributes;++n){var p=d.def(g.attributes,"[",n,"]"),q=a.cond(p,".buffer");q.then(h,".enableVertexAttribArray(",n,");",h,".bindBuffer(",34962,",",p,".buffer.buffer);",h,".vertexAttribPointer(",n,",",p,".size,",p,".type,",p,".normalized,",p,".stride,",p,".offset);")["else"](h,
".disableVertexAttribArray(",n,");",h,".vertexAttrib4f(",n,",",p,".x,",p,".y,",p,".z,",p,".w);",p,".buffer=null;");d(q);X&&d(m,".vertexAttribDivisorANGLE(",n,",",p,".divisor);")}d(a.shared.vao,".currentVAO=null;",a.shared.vao,".setVAO(",a.shared.vao,".targetVAO);");Object.keys(sa).forEach(function(c){var e=sa[c],g=f.def(l,".",c),m=a.block();m("if(",g,"){",h,".enable(",e,")}else{",h,".disable(",e,")}",k,".",c,"=",g,";");d(m);b("if(",g,"!==",k,".",c,"){",m,"}")});Object.keys(ta).forEach(function(c){var e=
ta[c],g=ra[c],m,n,p=a.block();p(h,".",e,"(");pa(g)?(e=g.length,m=a.global.def(l,".",c),n=a.global.def(k,".",c),p(S(e,function(a){return m+"["+a+"]"}),");",S(e,function(a){return n+"["+a+"]="+m+"["+a+"];"}).join("")),b("if(",S(e,function(a){return m+"["+a+"]!=="+n+"["+a+"]"}).join("||"),"){",p,"}")):(m=f.def(l,".",c),n=f.def(k,".",c),p(m,");",k,".",c,"=",m,";"),b("if(",m,"!==",n,"){",p,"}"));d(p)});return a.compile()}(),compile:function(a,b,c,d,e){var f=D();f.stats=f.link(e);Object.keys(b["static"]).forEach(function(a){aa(f,
b,a)});Yb.forEach(function(b){aa(f,a,b)});var g=z(a,b,c,d,f);Ea(f,g);ja(f,g);W(f,g);return N(f.compile(),{destroy:function(){g.shader.program.destroy()}})}}}function Bb(a,b){for(var c=0;c<a.length;++c)if(a[c]===b)return c;return-1}var N=function(a,b){for(var c=Object.keys(b),e=0;e<c.length;++e)a[c[e]]=b[c[e]];return a},Db=0,Y={DynamicVariable:Z,define:function(a,b){return new Z(a,cb(b+""))},isDynamic:function(a){return"function"===typeof a&&!a._reglType||a instanceof Z},unbox:db,accessor:cb},bb={next:"function"===
typeof requestAnimationFrame?function(a){return requestAnimationFrame(a)}:function(a){return setTimeout(a,16)},cancel:"function"===typeof cancelAnimationFrame?function(a){return cancelAnimationFrame(a)}:clearTimeout},Cb="undefined"!==typeof performance&&performance.now?function(){return performance.now()}:function(){return+new Date},I=hb();I.zero=hb();var Zb=function(a,b){var c=1;b.ext_texture_filter_anisotropic&&(c=a.getParameter(34047));var e=1,f=1;b.webgl_draw_buffers&&(e=a.getParameter(34852),
f=a.getParameter(36063));var d=!!b.oes_texture_float;if(d){d=a.createTexture();a.bindTexture(3553,d);a.texImage2D(3553,0,6408,1,1,0,6408,5126,null);var q=a.createFramebuffer();a.bindFramebuffer(36160,q);a.framebufferTexture2D(36160,36064,3553,d,0);a.bindTexture(3553,null);if(36053!==a.checkFramebufferStatus(36160))d=!1;else{a.viewport(0,0,1,1);a.clearColor(1,0,0,1);a.clear(16384);var n=I.allocType(5126,4);a.readPixels(0,0,1,1,6408,5126,n);a.getError()?d=!1:(a.deleteFramebuffer(q),a.deleteTexture(d),
d=1===n[0]);I.freeType(n)}}n=!0;"undefined"!==typeof navigator&&(/MSIE/.test(navigator.userAgent)||/Trident\//.test(navigator.appVersion)||/Edge/.test(navigator.userAgent))||(n=a.createTexture(),q=I.allocType(5121,36),a.activeTexture(33984),a.bindTexture(34067,n),a.texImage2D(34069,0,6408,3,3,0,6408,5121,q),I.freeType(q),a.bindTexture(34067,null),a.deleteTexture(n),n=!a.getError());return{colorBits:[a.getParameter(3410),a.getParameter(3411),a.getParameter(3412),a.getParameter(3413)],depthBits:a.getParameter(3414),
...
maxVertexUniforms:a.getParameter(36347),maxVertexTextureUnits:a.getParameter(35660),maxVaryingVectors:a.getParameter(36348),maxFragmentUniforms:a.getParameter(36349),glsl:a.getParameter(35724),renderer:a.getParameter(7937),vendor:a.getParameter(7936),version:a.getParameter(7938),readFloat:d,npotTextureCube:n}},Q=function(a){return a instanceof Uint8Array||a instanceof Uint16Array||a instanceof Uint32Array||a instanceof Int8Array||a instanceof Int16Array||a instanceof Int32Array||a instanceof Float32Array||
a instanceof Float64Array||a instanceof Uint8ClampedArray},K=function(a){return Object.keys(a).map(function(b){return a[b]})},Qa={shape:function(a){for(var b=[];a.length;a=a[0])b.push(a.length);return b},flatten:function(a,b,c,e){var f=1;if(b.length)for(var d=0;d<b.length;++d)f*=b[d];else f=0;c=e||I.allocType(c,f);switch(b.length){case 0:break;case 1:e=b[0];for(b=0;b<e;++b)c[b]=a[b];break;case 2:e=b[0];b=b[1];for(d=f=0;d<e;++d)for(var q=a[d],n=0;n<b;++n)c[f++]=q[n];break;case 3:ib(a,b[0],b[1],b[2],
c,0);break;default:jb(a,b,0,c,0)}return c}},Ha={"[object Int8Array]":5120,"[object Int16Array]":5122,"[object Int32Array]":5124,"[object Uint8Array]":5121,"[object Uint8ClampedArray]":5121,"[object Uint16Array]":5123,"[object Uint32Array]":5125,"[object Float32Array]":5126,"[object Float64Array]":5121,"[object ArrayBuffer]":5121},Ja={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126},nb={dynamic:35048,stream:35040,"static":35044},Ua=Qa.flatten,mb=Qa.shape,
ma=[];ma[5120]=1;ma[5122]=2;ma[5124]=4;ma[5121]=1;ma[5123]=2;ma[5125]=4;ma[5126]=4;var Ka={points:0,point:0,lines:1,line:1,triangles:4,triangle:4,"line loop":2,"line strip":3,"triangle strip":5,"triangle fan":6},pb=new Float32Array(1),Lb=new Uint32Array(pb.buffer),Pb=[9984,9986,9985,9987],Oa=[0,6409,6410,6407,6408],V={};V[6409]=V[6406]=V[6402]=1;V[34041]=V[6410]=2;V[6407]=V[35904]=3;V[6408]=V[35906]=4;var Xa=qa("HTMLCanvasElement"),Ya=qa("OffscreenCanvas"),ub=qa("CanvasRenderingContext2D"),vb=qa("ImageBitmap"),
wb=qa("HTMLImageElement"),xb=qa("HTMLVideoElement"),Mb=Object.keys(Ha).concat([Xa,Ya,ub,vb,wb,xb]),ya=[];ya[5121]=1;ya[5126]=4;ya[36193]=2;ya[5123]=2;ya[5125]=4;var E=[];E[32854]=2;E[32855]=2;E[36194]=2;E[34041]=4;E[33776]=.5;E[33777]=.5;E[33778]=1;E[33779]=1;E[35986]=.5;E[35987]=1;E[34798]=1;E[35840]=.5;E[35841]=.25;E[35842]=.5;E[35843]=.25;E[36196]=.5;var R=[];R[32854]=2;R[32855]=2;R[36194]=2;R[33189]=2;R[36168]=1;R[34041]=4;R[35907]=4;R[34836]=16;R[34842]=8;R[34843]=6;var $b=function(a,b,c,e,f){function d(a){this.id=
h++;this.refCount=1;this.renderbuffer=a;this.format=32854;this.height=this.width=0;f.profile&&(this.stats={size:0})}function q(b){var c=b.renderbuffer;a.bindRenderbuffer(36161,null);a.deleteRenderbuffer(c);b.renderbuffer=null;b.refCount=0;delete v[b.id];e.renderbufferCount--}var n={rgba4:32854,rgb565:36194,"rgb5 a1":32855,depth:33189,stencil:36168,"depth stencil":34041};b.ext_srgb&&(n.srgba=35907);b.ext_color_buffer_half_float&&(n.rgba16f=34842,n.rgb16f=34843);b.webgl_color_buffer_float&&(n.rgba32f=
34836);var u=[];Object.keys(n).forEach(function(a){u[n[a]]=a});var h=0,v={};d.prototype.decRef=function(){0>=--this.refCount&&q(this)};f.profile&&(e.getTotalRenderbufferSize=function(){var a=0;Object.keys(v).forEach(function(b){a+=v[b].stats.size});return a});return{create:function(b,c){function h(b,c){var d=0,e=0,m=32854;"object"===typeof b&&b?("shape"in b?(e=b.shape,d=e[0]|0,e=e[1]|0):("radius"in b&&(d=e=b.radius|0),"width"in b&&(d=b.width|0),"height"in b&&(e=b.height|0)),"format"in b&&(m=n[b.format])):
"number"===typeof b?(d=b|0,e="number"===typeof c?c|0:d):b||(d=e=1);if(d!==k.width||e!==k.height||m!==k.format)return h.width=k.width=d,h.height=k.height=e,k.format=m,a.bindRenderbuffer(36161,k.renderbuffer),a.renderbufferStorage(36161,m,d,e),f.profile&&(k.stats.size=R[k.format]*k.width*k.height),h.format=u[k.format],h}var k=new d(a.createRenderbuffer());v[k.id]=k;e.renderbufferCount++;h(b,c);h.resize=function(b,c){var d=b|0,e=c|0||d;if(d===k.width&&e===k.height)return h;h.width=k.width=d;h.height=
k.height=e;a.bindRenderbuffer(36161,k.renderbuffer);a.renderbufferStorage(36161,k.format,d,e);f.profile&&(k.stats.size=R[k.format]*k.width*k.height);return h};h._reglType="renderbuffer";h._renderbuffer=k;f.profile&&(h.stats=k.stats);h.destroy=function(){k.decRef()};return h},clear:function(){K(v).forEach(q)},restore:function(){K(v).forEach(function(b){b.renderbuffer=a.createRenderbuffer();a.bindRenderbuffer(36161,b.renderbuffer);a.renderbufferStorage(36161,b.format,b.width,b.height)});a.bindRenderbuffer(36161,
null)}}},Za=[];Za[6408]=4;Za[6407]=3;var Ra=[];Ra[5121]=1;Ra[5126]=4;Ra[36193]=2;var Ca=["x","y","z","w"],Yb="blend.func blend.equation stencil.func stencil.opFront stencil.opBack sample.coverage viewport scissor.box polygonOffset.offset".split(" "),Fa={0:0,1:1,zero:0,one:1,"src color":768,"one minus src color":769,"src alpha":770,"one minus src alpha":771,"dst color":774,"one minus dst color":775,"dst alpha":772,"one minus dst alpha":773,"constant color":32769,"one minus constant color":32770,"constant alpha":32771,
"one minus constant alpha":32772,"src alpha saturate":776},ab={never:512,less:513,"<":513,equal:514,"=":514,"==":514,"===":514,lequal:515,"<=":515,greater:516,">":516,notequal:517,"!=":517,"!==":517,gequal:518,">=":518,always:519},Ta={0:0,zero:0,keep:7680,replace:7681,increment:7682,decrement:7683,"increment wrap":34055,"decrement wrap":34056,invert:5386},zb={cw:2304,ccw:2305},Ab=new L(!1,!1,!1,function(){}),ac=function(a,b){function c(){this.endQueryIndex=this.startQueryIndex=-1;this.sum=0;this.stats=
null}function e(a,b,d){var e=q.pop()||new c;e.startQueryIndex=a;e.endQueryIndex=b;e.sum=0;e.stats=d;n.push(e)}if(!b.ext_disjoint_timer_query)return null;var f=[],d=[],q=[],n=[],u=[],h=[];return{beginQuery:function(a){var c=f.pop()||b.ext_disjoint_timer_query.createQueryEXT();b.ext_disjoint_timer_query.beginQueryEXT(35007,c);d.push(c);e(d.length-1,d.length,a)},endQuery:function(){b.ext_disjoint_timer_query.endQueryEXT(35007)},pushScopeStats:e,update:function(){var a,c;a=d.length;if(0!==a){h.length=
Math.max(h.length,a+1);u.length=Math.max(u.length,a+1);u[0]=0;var e=h[0]=0;for(c=a=0;c<d.length;++c){var p=d[c];b.ext_disjoint_timer_query.getQueryObjectEXT(p,34919)?(e+=b.ext_disjoint_timer_query.getQueryObjectEXT(p,34918),f.push(p)):d[a++]=p;u[c+1]=e;h[c+1]=a}d.length=a;for(c=a=0;c<n.length;++c){var e=n[c],k=e.startQueryIndex,p=e.endQueryIndex;e.sum+=u[p]-u[k];k=h[k];p=h[p];p===k?(e.stats.gpuTime+=e.sum/1E6,q.push(e)):(e.startQueryIndex=k,e.endQueryIndex=p,n[a++]=e)}n.length=a}},getNumPendingQueries:function(){return d.length},
clear:function(){f.push.apply(f,d);for(var a=0;a<f.length;a++)b.ext_disjoint_timer_query.deleteQueryEXT(f[a]);d.length=0;f.length=0},restore:function(){d.length=0;f.length=0}}};return function(a){function b(){if(0===G.length)t&&t.update(),ea=null;else{ea=bb.next(b);v();for(var a=G.length-1;0<=a;--a){var c=G[a];c&&c(J,null,0)}p.flush();t&&t.update()}}function c(){!ea&&0<G.length&&(ea=bb.next(b))}function e(){ea&&(bb.cancel(b),ea=null)}function f(a){a.preventDefault();e();S.forEach(function(a){a()})}
function d(a){p.getError();g.restore();H.restore();y.restore();z.restore();Q.restore();T.restore();M.restore();t&&t.restore();K.procs.refresh();c();V.forEach(function(a){a()})}function q(a){function b(a,c){var d={},e={};Object.keys(a).forEach(function(b){var f=a[b];if(Y.isDynamic(f))e[b]=Y.unbox(f,b);else{if(c&&Array.isArray(f))for(var g=0;g<f.length;++g)if(Y.isDynamic(f[g])){e[b]=Y.unbox(f,b);return}d[b]=f}});return{dynamic:e,"static":d}}function c(a){for(;n.length<a;)n.push(null);return n}var d=
b(a.context||{},!0),e=b(a.uniforms||{},!0),f=b(a.attributes||{},!1);a=b(function(a){function b(a){if(a in c){var d=c[a];delete c[a];Object.keys(d).forEach(function(b){c[a+"."+b]=d[b]})}}var c=N({},a);delete c.uniforms;delete c.attributes;delete c.context;delete c.vao;"stencil"in c&&c.stencil.op&&(c.stencil.opBack=c.stencil.opFront=c.stencil.op,delete c.stencil.op);b("blend");b("depth");b("cull");b("stencil");b("polygonOffset");b("scissor");b("sample");"vao"in a&&(c.vao=a.vao);return c}(a),!1);var g=
{gpuTime:0,cpuTime:0,count:0},h=K.compile(a,f,e,d,g),k=h.draw,l=h.batch,m=h.scope,n=[];return N(function(a,b){var d;if("function"===typeof a)return m.call(this,null,a,0);if("function"===typeof b)if("number"===typeof a)for(d=0;d<a;++d)m.call(this,null,b,d);else if(Array.isArray(a))for(d=0;d<a.length;++d)m.call(this,a[d],b,d);else return m.call(this,a,b,0);else if("number"===typeof a){if(0<a)return l.call(this,c(a|0),a|0)}else if(Array.isArray(a)){if(a.length)return l.call(this,a,a.length)}else return k.call(this,
a)},{stats:g,destroy:function(){h.destroy()}})}function n(a,b){var c=0;K.procs.poll();var d=b.color;d&&(p.clearColor(+d[0]||0,+d[1]||0,+d[2]||0,+d[3]||0),c|=16384);"depth"in b&&(p.clearDepth(+b.depth),c|=256);"stencil"in b&&(p.clearStencil(b.stencil|0),c|=1024);p.clear(c)}function u(a){G.push(a);c();return{cancel:function(){function b(){var a=Bb(G,b);G[a]=G[G.length-1];--G.length;0>=G.length&&e()}var c=Bb(G,a);G[c]=b}}}function h(){var a=R.viewport,b=R.scissor_box;a[0]=a[1]=b[0]=b[1]=0;J.viewportWidth=
J.framebufferWidth=J.drawingBufferWidth=a[2]=b[2]=p.drawingBufferWidth;J.viewportHeight=J.framebufferHeight=J.drawingBufferHeight=a[3]=b[3]=p.drawingBufferHeight}function v(){J.tick+=1;J.time=x();h();K.procs.poll()}function m(){z.refresh();h();K.procs.refresh();t&&t.update()}function x(){return(Cb()-I)/1E3}a=Hb(a);if(!a)return null;var p=a.gl,k=p.getContextAttributes();p.isContextLost();var g=Ib(p,a);if(!g)return null;var r=Eb(),l={vaoCount:0,bufferCount:0,elementsCount:0,framebufferCount:0,shaderCount:0,
textureCount:0,cubeCount:0,renderbufferCount:0,maxTextureUnits:0},D=g.extensions,t=ac(p,D),I=Cb(),E=p.drawingBufferWidth,L=p.drawingBufferHeight,J={tick:0,time:0,viewportWidth:E,viewportHeight:L,framebufferWidth:E,framebufferHeight:L,drawingBufferWidth:E,drawingBufferHeight:L,pixelRatio:a.pixelRatio},E={elements:null,primitive:4,count:-1,offset:0,instances:-1},O=Zb(p,D),y=Jb(p,l,a,function(a){return M.destroyBuffer(a)}),U=Kb(p,D,y,l),M=Sb(p,D,O,l,y,U,E),H=Tb(p,r,l,a),z=Nb(p,D,O,function(){K.procs.poll()},
J,l,a),Q=$b(p,D,O,l,a),T=Rb(p,D,O,z,Q,l),K=Wb(p,r,D,O,y,U,z,T,{},M,H,E,J,t,a),r=Ub(p,T,K.procs.poll,J,k,D,O),R=K.next,P=p.canvas,G=[],S=[],V=[],Z=[a.onDestroy],ea=null;P&&(P.addEventListener("webglcontextlost",f,!1),P.addEventListener("webglcontextrestored",d,!1));var aa=T.setFBO=q({framebuffer:Y.define.call(null,1,"framebuffer")});m();k=N(q,{clear:function(a){if("framebuffer"in a)if(a.framebuffer&&"framebufferCube"===a.framebuffer_reglType)for(var b=0;6>b;++b)aa(N({framebuffer:a.framebuffer.faces[b]},
a),n);else aa(a,n);else n(null,a)},prop:Y.define.bind(null,1),context:Y.define.bind(null,2),"this":Y.define.bind(null,3),draw:q({}),buffer:function(a){return y.create(a,34962,!1,!1)},elements:function(a){return U.create(a,!1)},texture:z.create2D,cube:z.createCube,renderbuffer:Q.create,framebuffer:T.create,framebufferCube:T.createCube,vao:M.createVAO,attributes:k,frame:u,on:function(a,b){var c;switch(a){case "frame":return u(b);case "lost":c=S;break;case "restore":c=V;break;case "destroy":c=Z}c.push(b);
return{cancel:function(){for(var a=0;a<c.length;++a)if(c[a]===b){c[a]=c[c.length-1];c.pop();break}}}},limits:O,hasExtension:function(a){return 0<=O.extensions.indexOf(a.toLowerCase())},read:r,destroy:function(){G.length=0;e();P&&(P.removeEventListener("webglcontextlost",f),P.removeEventListener("webglcontextrestored",d));H.clear();T.clear();Q.clear();M.clear();z.clear();U.clear();y.clear();t&&t.clear();Z.forEach(function(a){a()})},_gl:p,_refresh:m,poll:function(){v();t&&t.update()},now:x,stats:l});
a.onDone(null,k);return k}});
